...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            return Emps.Where(e1 => e1.Salary == Emps.Max(e2 => e2.Salary));
        }
        ...
        {
            return Emps.FirstOrDefault(e => e.Job == "Frontend programmer");
        }
        ...
        {
            return Emps.TaskGetEmpsWithBosses();
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            return Depts.GroupJoin(
                    ...
                    (d, e) => new
                    {
                        Dept = d,
                        EmpCount = e.Count()
                    }).Where(entry => entry.EmpCount == 0 && entry.EmpCount == 0)
    ...
    {
        public static IEnumerable<Emp> TaskGetEmpsWithBosses(this IEnumerable<Emp> emps)
        {
            return emps.Where(e1 => emps.Any(e2 => e2.Mgr?.Empno == e1.Empno))
                .OrderBy(e => e.Ename)
